...
namespace Sayohime.Scenes.MapScene
{
    public class AnnouncePopup : Overlay
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            textbox.Bounds = new Rectangle(0, 0, width + 15, height * textLines.Count() + 5);
            ...
            {
                Text.DrawCenteredText(spriteBatch, centerPoint - new Vector2(0, 4 * (textLines.Length - 1) - 1), PROMPT_FONT, text, color, 0.03f, row);
                row++;
            }
        }
    }
