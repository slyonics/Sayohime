...
namespace Sayohime.SceneObjects
{
    ...
    {
        private const float DEFAULT_GRAVITY = 2000.0f;
        ...
        public Entity3D(Scene iScene, Vector2 iPosition, Texture2D iSprite, Dictionary<string, Animation> iAnimationList)
        {
            parentScene = iScene;
            position = iPosition;
        ...
        public Entity3D(Scene iScene, Vector2 iPosition)
        {
            parentScene = iScene;
            position = iPosition;
        }
